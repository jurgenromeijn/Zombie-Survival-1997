		...
		while (true)
		{
			...
			switch (gameState)
			{
				...
				case VISUALIZING:
					...
					// So we wait one second for the window/frame to be set to
					// its correct size. Just in case we
					// also insert 'this.getWidth() > 1' condition in case when
					// the window/frame size wasn't set in time,
